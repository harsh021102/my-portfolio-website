...
const Navbar = () => {
  return (
    <div className='h-1/12 w-full sm:w-16 md:w-16 rounded-b-xl sm:rounded-none sm:rounded-r-xl sm:h-full flex flex-row md:flex-col justify-center items-center bg-nav-black'>
